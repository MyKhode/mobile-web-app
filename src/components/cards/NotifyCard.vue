<template>
  <div
    class="bg-gradient-to-br from-sky-400 via-sky-400 to-violet-400 px-4 py-4 sm:p-10 rounded-2xl w-full text-white flex items-center justify-between max-w-4xl mx-auto mt-20"
  >
    <div class="flex flex-col gap-6">
      <div class="">
        <span class="text-gray-200">Top Up Offers</span>
        <br />
        <span class="text-gray-200 text-xl lg:text-4xl text-white  ">5% extra every top up - <span class="text-rose-400">khqr</span></span>
      </div>
      <a
        href=""
        target="_blank"
